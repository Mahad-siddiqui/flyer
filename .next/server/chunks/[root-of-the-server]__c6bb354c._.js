...
"[project]/.next-internal/server/app/api/flyers/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/flyers/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [flyers, totalCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.findMany({
                where,
                select: {
                    id: true,
                    title: true,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.count({
                where
            })
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        if (user.plan?.flyerLimit !== -1 && user._count.flyers >= (user.plan?.flyerLimit || 5)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { title, originalFileName, filePath, fileType, fileSize, extractedData, category, templateId } = body;
        // Generate short URL
        const shortUrl = Math.random().toString(36).substring(2, 10);
        const generatedUrl = `${process.env.NEXTAUTH_URL}/f/${shortUrl}`;
        const flyer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.create({
            data: {
                userId,
                title,
                originalFileName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6bb354c._.js.map