...
"[project]/.next-internal/server/app/api/flyers/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
    ...
    callbacks: {
        ...
        async session ({ session, token }) {
            ...
            session.user = {
                ...
                flyersUsed: token.flyersUsed,
                plan: token.plan,
                flyerCount: token.flyerCount
            };
            return session;
        },
            ...
            try {
                if (account?.provider === "google") {
                    ...
                    if (!existingUser) {
                        ...
                        const freePlan = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].plan.findFirst({
                            where: {
                                name: "Free"
                            }
                        });
...
"[project]/src/app/api/flyers/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const flyer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.findFirst({
            where: {
                id: params.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(flyer);
    } catch (error) {
...
async function PATCH(request, { params }) {
    try {
        ...
        const existingFlyer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.findFirst({
            where: {
                id: params.id,
                userId: session.user.id
            }
        ...
        // Update the flyer
        const updatedFlyer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.update({
            where: {
                id: params.id
            },
            data: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedFlyer);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        ...
        // Delete the flyer
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b371ca0._.js.map