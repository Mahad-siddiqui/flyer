...
async function GET(request) {
    try {
        ...
        const flyers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flyer.findMany({
            where: {
                userId
            },
            select: {
        ...
        const flyersThisMonth = flyers.filter((flyer)=>new Date(flyer.createdAt) >= currentMonth).length;
        const stats = {
            totalFlyers,
            totalViews,
            totalScans,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89b2bd84._.js.map