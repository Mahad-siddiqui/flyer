        ...
        <div className="container relative z-10 px-4 py-20 mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-3 py-1 text-sm backdrop-blur-sm mb-6">
              ...
              <span className="text-white/90">Try it FREE - No Credit Card Required</span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed">
              Turn your static document into an interactive hub in seconds, completely free.
              Upload, customize, and preview instantly - no signup required until you're ready to publish!
            </p>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Experience the full process before deciding to sign up. No commitment required!
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <Card className="feature-card text-center relative">
                ...
                <CardHeader className="pt-8">
                  ...
                  <CardTitle className="text-xl">Upload Your Document</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    Drop any file - PDF, Word, PNG, JPEG. Our AI instantly processes and extracts 
                    layout, data, and editable fields.
                  </CardDescription>
              ...
              <Card className="feature-card text-center relative">
                ...
                <CardHeader className="pt-8">
                  ...
                  <CardTitle className="text-xl">Select Your Template</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    Choose from professional templates: Event Flyer, Registration Form, 
                    Invoice, and more. Perfect fit guaranteed.
                  </CardDescription>
                  <div className="mt-4 text-sm text-green-600 font-medium">
              ...
              <Card className="feature-card text-center relative">
                ...
                <CardHeader className="pt-8">
                  ...
                  <CardTitle className="text-xl">Preview & Edit Fields</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    See your interactive document come to life! Edit fields, customize content, 
                    and perfect your design in real-time.
                  </CardDescription>
                  <div className="mt-4 text-sm text-green-600 font-medium">
                    ✓ Full preview access
                  </div>
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-4 p-6 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl border border-primary/20">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">Sign up in seconds to get your QR code and shareable link</p>
                </div>
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">Get your QR code and link instantly</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-3">
                Experience everything before you commit. No credit card required.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Experience the full process - upload, customize, preview - all before signing up
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  No credit card, no email required until you're ready to publish
                </p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <div className="text-muted-foreground">Documents Transformed</div>
              </div>
              <div className="text-center">
            ...
            <blockquote className="text-xl italic text-muted-foreground mb-8 max-w-2xl mx-auto">
              "I was amazed how quickly I could turn my event flyer into an interactive webpage. 
              The try-before-signup approach let me see exactly what I was getting!"
            </blockquote>
            <cite className="text-sm font-medium">— Sarah J., Event Coordinator</cite>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Start your free trial now. Experience everything before you commit. 
              No credit card required until you're ready to publish.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-4">
              ✓ No signup required to try  ✓ Full preview access  ✓ Professional templates
            </p>
          </div>
        </div>
      </section>
